      ...
      <div className="panel project-editor-panel certificate-editor-panel">
        ...
        <div className="project-editor-section">
          ...
          <div className="project-publishing-options">
            <label
              className={`project-publishing-option ${certificate.visible ? 'is-active' : ''}`}
            >
              <input
                type="checkbox"
            ...
            <label
              className={`project-publishing-option ${certificate.featured ? 'is-active' : ''}`}
            >
              <input
                type="checkbox"
        ...
        <footer className="panel-footer project-editor-actions">
          ...
          <div>
            ...
            <button
              ...
              type="button"
              disabled={isSaving}
              onClick={() => saveCertificate('published')}
            >
