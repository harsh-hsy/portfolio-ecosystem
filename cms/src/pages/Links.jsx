...
function validateLinksForm(form) {
  return validateForm(form, {
    github: [
      validators.required('GitHub URL is required.'),
      validators.url('Enter a valid GitHub URL.'),
    ],
    linkedin: [
      validators.required('LinkedIn URL is required.'),
      validators.url('Enter a valid LinkedIn URL.'),
    ],
    email: [
    ...
    resume: [
      validators.required('Resume URL is required.'),
      validators.url('Enter a valid resume URL.'),
    ],
    location: [validators.required('Location is required.'), validators.maxLength(80)],
    mapUrl: [
      validators.required('Location map URL is required.'),
      validators.url('Enter a valid map URL.'),
    ],
  })
}
...
function Links() {
  ...
  return (
    <section className="page">
      <form
        className="panel content-editor structured-content-editor links-editor"
      ...
      >
        <div className="content-editor__header">
          <div>
            ...
            <h2>Profile Links</h2>
            <p>
              These values power navbar actions, footer links, contact links, and resume downloads.
            </p>
          </div>
        ...
        <div className="content-editor__section">
          ...
          <div className="form-grid">
            <FormField
              label="GitHub URL"
              name="github"
              value={editor.form.github}
              onChange={editor.updateField}
              error={editor.errors.github}
              required
            />
            <FormField
              label="LinkedIn URL"
              name="linkedin"
              value={editor.form.linkedin}
              onChange={editor.updateField}
              error={editor.errors.linkedin}
              required
            />
          </div>
        </div>
        ...
        <div className="content-editor__section">
          ...
          <div className="form-grid">
            ...
            <FormField
              ...
              value={editor.form.mapUrl}
              onChange={editor.updateField}
              error={editor.errors.mapUrl}
              required
            />
          </div>
        </div>
        ...
        <div className="content-editor__section">
          ...
          <div className="form-grid">
            <FormField
              ...
              name="resume"
              className="form-group--wide"
              value={editor.form.resume}
              onChange={editor.updateField}
              error={editor.errors.resume}
              required
            />
          </div>
        </div>
